...
#footer .container .item__footer {
  width: 30%;
}

#footer .container .item__footer:first-child {
  width: 50%;
}

#footer .container .item__footer:first-child p {
  width: 80%;
  margin-top: 1.5rem;
}

#footer .container .item__footer:first-child ul {
  display: flex;
  gap: 1rem;
}

#footer .container .item__footer > ul {
  margin-top: 2rem;
}

#footer .container .item__footer > ul li {
  margin-bottom: 0.8rem;
}

#footer .container .item__footer > ul li a {
  color: #292929;
}
</style>
